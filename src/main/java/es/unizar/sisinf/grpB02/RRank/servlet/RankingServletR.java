 ...
 */
@WebServlet("/RankingServletR")
public class RankingServletR extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RankingServletR() {
        super();
		...
		boolean exitoso = false;
		 try {
	            ...
	            if (!clasifica.isEmpty()) {
	                ...
	                RequestDispatcher dispatcher = request.getRequestDispatcher("Pantallas/rankingR.jsp");
