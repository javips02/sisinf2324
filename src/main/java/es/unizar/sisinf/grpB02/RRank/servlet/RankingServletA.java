 ...
 */
@WebServlet("/RankingServletA")
public class RankingServletA extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RankingServletA() {
        super();
		...
		boolean exitoso = false;
		 try {
	            ...
	            if (!clasifica.isEmpty()) {
	                ...
	                RequestDispatcher dispatcher = request.getRequestDispatcher("Pantallas/rankingA.jsp");
