 ...
 */
@WebServlet("/RankingServletB")
public class RankingServletB extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RankingServletB() {
        super();
		...
		boolean exitoso = false;
		 try {
	            ...
	            if (!clasifica.isEmpty()) {
	                ...
	                RequestDispatcher dispatcher = request.getRequestDispatcher("Pantallas/rankingB.jsp");
