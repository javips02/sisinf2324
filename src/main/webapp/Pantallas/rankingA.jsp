...
<!--          </div> -->
         ...
         <div class="marcador"> 
		    ...
		    <form id="formICactus" action="${pageContext.request.contextPath}/RankingServletC" method="get">
		        <input type="hidden" name="nombreRanking" value="Cactus">
		    	<a href="#">
		    		<img src="Pantallas/img/arrow_left.svg" alt="" class="arrowl" onclick="document.getElementById('formICactus').submit()">	
		    	</a>
		    </form>
		    
		    <p class="cuadrado"></p>
		    
		    <form id="formDRoble" action="${pageContext.request.contextPath}/RankingServletR" method="get">
		        <input type="hidden" name="nombreRanking" value="Roble">
		    	<a href="#">
		    		<img src="Pantallas/img/arrow_right.svg" alt="" class="arrowr" onclick="document.getElementById('formDRoble').submit()">	
		    	</a>
		    </form>
		 </div>  
