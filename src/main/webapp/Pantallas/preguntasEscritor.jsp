...
/*              margin-right: 10%;  */
  ...
  <body>
    <div class="container">
        ...
        <div class="preguntas">
            <p class="boton-personalizado3">Pregunta número 1 del escritor</p>
            <p class="boton-recompensa">Máx. 10</p>
        ...
        <div class="preguntas3">
            <p class="boton-personalizado3">Pregunta número 2 del escritor</p>
            <p class="boton-recompensa">Máx. 10</p>
            <img src="img/Gold_Star.png" alt="" class="star">
        </div>
        ...
        <div class="preguntas5">
            <p class="boton-personalizado3">Pregunta número 3 del escritor</p>
            <p class="boton-recompensa">Máx. 10</p>
            <img src="img/Gold_Star.png" alt="" class="star">
        </div>
