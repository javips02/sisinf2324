...
<!--          </div> -->
          ...
          <div class="marcador"> 
		    ...
		    <form id="formIAbeto" action="${pageContext.request.contextPath}/RankingServletA" method="get">
		        <input type="hidden" name="nombreRanking" value="Abeto">
		    	<a href="#">
		    		<img src="Pantallas/img/arrow_left.svg" alt="" class="arrowl" onclick="document.getElementById('formIAbeto').submit()">	
		    	</a>
		    </form>
		    
		    <p class="cuadrado"></p>
		    
		    <form id="formDBonsai" action="${pageContext.request.contextPath}/RankingServletB" method="get">
		        <input type="hidden" name="nombreRanking" value="Bonsai">
		    	<a href="#">
		    		<img src="Pantallas/img/arrow_right.svg" alt="" class="arrowr" onclick="document.getElementById('formDBonsai').submit()">	
		    	</a>
		    </form>
		 </div>  
